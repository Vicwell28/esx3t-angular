...
import { DialogsFormProductComponent } from 'src/app/layout/components/DialogsForms/product/df-product/df-product.component';
...
export class ViewProductComponent implements AfterViewInit {
  ...
  constructor(private dialog: MatDialog, private ProductService:ProductService) {}
   ...
   openDialog(
    ...
    this.dialogRef = this.dialog.open(DialogsFormProductComponent, {
      width: '50%',
      height: '90%',
  ...
  getAllProducts(): void {
    ...
    this.ProductService.indexProduct().subscribe({
      next: (value) => {
        ...
        this.dataSource = new MatTableDataSource(value.data as IProduct[]);
